...
def main() -> None:
    ...
    harmonize(Data.dimensions_pyamdf, 'Emissions|CO2', Resilience.historic_emissions, 2005, False,
              2050)



"""
Code below from Robin Lamboll (2024) for harmonising data
https://www.nature.com/articles/s41558-023-01848-5

"""

def harmonize(df, var, harm_df, startyear, offset=False, unity_year=int):
